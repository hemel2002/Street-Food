CREATE TABLE "SYSTEM"."CUSTOMERREVIEWSVENDOR" (
    ...
    "V_ID" VARCHAR2(100) NOT NULL ENABLE,
    ...
    "V_NAME" VARCHAR2(100),
    "C_EMAIL" VARCHAR2(150) NOT NULL ENABLE,
    "COMPLAINT_DETAILS" "SYSTEM"."COMPLAINTS",
    CONSTRAINT "PK_CUSTOMERREVIEWSVENDOR" PRIMARY KEY ("C_ID", "V_ID") USING INDEX ENABLE,
    CONSTRAINT "FK_CUSTOMERREVIEWSVENDOR_C_ID" FOREIGN KEY ("C_ID") REFERENCES "SYSTEM"."CUSTOMERS" ("C_ID") ON DELETE CASCADE ENABLE,
