window.innerWidth < 768 &&
    ...
    !(function () {
      ...
      function a() {
        ...
        for (var a = 0; a < e.length; a++) {
          var s = e[a].getBoundingClientRect(),
            r =
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    const e = document.querySelector('.navbar'),
      t =
        parseInt(document.querySelector('.main-header').clientHeight / 2) || 80,
      n = e.dataset.backgroundColor || 'bg-body-tertiary',
      a = e.dataset.navbarShadow || 'shadow-none',
      o = (t) => {
        e.classList.toggle(n, t), e.classList.toggle(a, t);
      },
      s = () => {
        window.innerWidth > 768 && o(window.scrollY > t);
      },
      r = () => o(window.innerWidth < 768);
    e
      ? (document.addEventListener('scroll', s),
        window.addEventListener('resize', r),
        r())
      : console.log('Navbar not found on the page');
  });
let tgBtns = document.querySelectorAll('.togglePassword');
tgBtns.forEach((e) => {
  e.addEventListener('click', function (e) {
    let t = e.target.closest('.togglePassword').previousSibling,
      n = document.querySelector('#eye-icon');
    'password' == t.type
      ? t.setAttribute('type', 'text')
      : t.setAttribute('type', 'password'),
      n.classList.toggle('ion-eye-disabled'),
      n.classList.toggle('ion-eye');
  });
});
